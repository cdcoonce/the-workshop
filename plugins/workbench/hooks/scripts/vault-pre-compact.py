...
Thin entry point. The implementation is ``machinery/engine/pre-compact.py``, which is
...
WORKSHOP_HOOK = {"event": "PreCompact", "runner": "vault"}
...
_TARGET = _ENGINE / "pre-compact.py"
